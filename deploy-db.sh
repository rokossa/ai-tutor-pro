...
echo "⚙️ 1. Creating the Database directory..."
mkdir -p backend/db

echo "⚙️ 2. Writing the PostgreSQL schema.sql file..."
cat << 'EOF' > backend/db/schema.sql
-- ==========================================
...
echo "🚀 3. Committing the Schema..."
git add .
git commit -m "chore: initialize PostgreSQL schema.sql for Knowledge Graph architecture"
