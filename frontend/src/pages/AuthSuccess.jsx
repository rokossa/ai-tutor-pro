...
export default function AuthSuccess() {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      // 2. Redirect them to the Onboarding Welcome page to set up their child
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-[#F8F9FA] font-sans">
