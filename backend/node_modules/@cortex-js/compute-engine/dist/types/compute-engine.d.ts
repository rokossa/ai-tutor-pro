/* 0.55.6 */export declare const version = "0.55.6";
...
export type { LatexDictionaryEntry, SerializeLatexOptions, ParseLatexOptions, LatexString, Parser, } from './compute-engine/latex-syntax/types';
