 ...
 */
export declare function tryGetConstant(expr: Expression): number | undefined;
/**
 ...
 */
export declare function tryGetComplexParts(expr: Expression, compile: (e: Expression) => string): {
    re: string | null;
    im: string | null;
} | null;
